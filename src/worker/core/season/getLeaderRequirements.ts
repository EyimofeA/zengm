...
const getLeaderRequirements = () => {
	...
	>({
		...
		basketball: {
			...
			rapm1Off: basketballAdvancedStats,
			rapm1Def: basketballAdvancedStats,
			rapm1: basketballAdvancedStats,
			rapm3Off: basketballAdvancedStats,
			rapm3Def: basketballAdvancedStats,
			rapm3: basketballAdvancedStats,
